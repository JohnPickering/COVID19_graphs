---
title: "European COVID19 Cases and Deaths; Rate of doubling."
...
df_g <- df_100[df_100$location == "Europe",] %>% 
...
g_cases_separate <- g_cases_separate + 
  ...
  ggtitle("Europe 29 March 2020", subtitle = "Author: JW Pickering; Data: John Hopkins University")

number_rows = ceiling(length(unique(df_g$country))/3)
  
ggsave(g_cases_separate, filename = "20-03-29 Europe Cases.jpg", width = 210  , height = 20 + 40 * number_rows , units = "mm")
(g_cases_separate)
```
...
df_g <- df_10[df_10$location == "Europe",] %>% 
  filter(!is.na(country))
...
ggsave(g_deaths_separate, filename = "20-03-29 Europe Deaths.jpg", width = 210  , height = 20 + 40 * number_rows , units = "mm")
(g_deaths_separate)
```
