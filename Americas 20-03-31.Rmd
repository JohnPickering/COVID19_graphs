...
ggsave(g_cases_separate, filename = "20-03-31 Americas Cases Comparisons.jpg", width = 210  , height = 20 + 40 * number_rows , units = "mm")
(g_cases_separate)
```
...
ggsave(g_deaths_separate, filename = "20-03-31 Americas deaths Comparisons.jpg", width = 210  , height = 20 + 40 * number_rows , units = "mm")
(g_deaths_separate)
```