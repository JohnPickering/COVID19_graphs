...
# Manually add
yesterday_cases_NZ = max(df_g[df_g$country == "New Zealand",]$confirmed) + 71
yesterday_cases_Aus = max(df_g[df_g$country == "Australia",]$confirmed) + 224
...
g_cases_separate <- g_cases_separate + 
  ...
  ggtitle("Oceania 2 April 2020", subtitle = "Author: JW Pickering; Data: John Hopkins University")

ggsave(g_cases_separate, filename = "20-04-02 Oceania Cases.jpg", width = 210  , height = 20 + 40 * number_rows, units = "mm")
(g_cases_separate)
```
...
ggsave(g_deaths_separate, filename = "20-04-02 Oceania Deaths.jpg", width = 210  , height = 20 + 40 * number_rows, units = "mm")
(g_deaths_separate)
```
