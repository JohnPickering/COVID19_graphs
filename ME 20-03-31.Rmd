...
g_cases_separate <- g_cases_separate + 
  ...
  ggtitle("ME 29 March 2020", subtitle = "Author: JW Pickering; Data: John Hopkins University")

ggsave(g_cases_separate, filename = "20-03-29 ME Cases.jpg", width = 210  , height = 20 + 40 * number_rows, units = "mm")
(g_cases_separate)
```
...
ggsave(g_deaths_separate, filename = "20-03-29 ME Deaths.jpg", width = 210  , height = 20 + 40 * number_rows, units = "mm")
(g_deaths_separate)
```
...
g_cases_separate <- ggplot() +
  ...
  theme(legend.position = "none",
        ...
        panel.grid = element_line(colour = "grey80"),
        panel.grid.minor = element_blank()) + 
  ggtitle("Morocco 29 March 2020", subtitle = "Author: JW Pickering; Data: John Hopkins University")



ggsave(g_cases_separate, filename = "20-03-29 Morocco  Cases.jpg", width = 210  , height = 20 + 35 * number_rows, units = "mm")
(g_cases_separate)
```
