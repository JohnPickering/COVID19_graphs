...
g_cases_separate <- g_cases_separate + 
  ...
  ggtitle("All countries 31 March 2020", subtitle = "Author: JW Pickering; Data: John Hopkins University")

number_rows = ceiling(length(unique(df_g$country))/8)

ggsave(g_cases_separate, filename = "20-03-31 All countries Cases.jpg", width = 420 , height = 20 + 40 * number_rows , units = "mm")
(g_cases_separate)
```
...
ggsave(g_cases_separate, filename = "20-03-31 All countries Cases Comparisons.jpg", width = 420 , height = 20 + 40 * number_rows , units = "mm")
(g_cases_separate)
```
...
ggsave(g_deaths_separate, filename = "20-03-31 All countries Deaths.jpg", width = 420 , height = 20 + 40 * number_rows , units = "mm")
(g_deaths_separate)
```
...
ggsave(g_deaths_separate, filename = "20-03-31 All countries deaths Comparisons.jpg", width = 420 , height = 20 + 40 * number_rows , units = "mm")
(g_deaths_separate)
```