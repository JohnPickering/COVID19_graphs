...
g_cases_separate <- g_cases_separate + 
  ...
  ggtitle("Europe 31 March 2020", subtitle = "Author: JW Pickering; Data: John Hopkins University")

number_rows = ceiling(length(unique(df_g$country))/3)
  
ggsave(g_cases_separate, filename = "20-03-31 Europe Cases.jpg", width = 210  , height = 20 + 40 * number_rows , units = "mm")
(g_cases_separate)
```
...
ggsave(g_deaths_separate, filename = "20-03-31 Europe Deaths.jpg", width = 210  , height = 20 + 40 * number_rows , units = "mm")
(g_deaths_separate)
```
