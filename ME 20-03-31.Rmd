---
title: "Gulf/Middle East COVID19 Cases and Deaths; Rate of doubling."
...
df_g <- df_100[df_100$location == "Gulf/Middle East",] %>% 
...
g_cases_separate <- g_cases_separate + 
  ...
  ggtitle("ME 31 March 2020", subtitle = "Author: JW Pickering; Data: John Hopkins University")

number_rows = ceiling(length(unique(df_g$country))/3)

ggsave(g_cases_separate, filename = "20-03-31 ME Cases.jpg", width = 210  , height = 20 + 40 * number_rows, units = "mm")
(g_cases_separate)
```
...
df_g <- df_10[df_10$location == "Gulf/Middle East",] %>% 
  filter(!is.na(country))
...
ggsave(g_deaths_separate, filename = "20-03-31 ME Deaths.jpg", width = 210  , height = 20 + 40 * number_rows, units = "mm")
(g_deaths_separate)
```



```{r , echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.height = 4, eval = FALSE}
# Example of a single country
df_g <- df_100[df_100$country == "Morocco",] 
...
g_cases_separate <- ggplot() +
  ...
  theme(legend.position = "none",
        ...
        panel.grid = element_line(colour = "grey80"),
        panel.grid.minor = element_blank()) + 
  ggtitle("Morocco 31 March 2020", subtitle = "Author: JW Pickering; Data: John Hopkins University")



ggsave(g_cases_separate, filename = "20-03-31 Morocco  Cases.jpg", width = 210  , height = 20 + 35 * number_rows, units = "mm")
(g_cases_separate)
```
