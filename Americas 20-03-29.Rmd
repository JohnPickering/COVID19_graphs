...
g_cases_separate <- g_cases_separate + 
  ...
  ggtitle("Americas 29 March 2020", subtitle = "Author: JW Pickering; Data: John Hopkins University")

number_rows = ceiling(length(unique(df_g$country))/3)

ggsave(g_cases_separate, filename = "20-03-29 Americas Cases.jpg", width = 210  , height = 20 + 40 * number_rows , units = "mm")
(g_cases_separate)
```
...
ggsave(g_deaths_separate, filename = "20-03-29 Americas Deaths.jpg", width = 210  , height = 20 + 40 * number_rows , units = "mm")
(g_deaths_separate)
```
